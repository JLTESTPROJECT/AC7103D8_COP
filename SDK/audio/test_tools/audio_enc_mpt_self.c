...
#pragma bss_seg(".audio_enc_mpt_self.data.bss")
#pragma data_seg(".audio_enc_mpt_self.data")
#pragma const_seg(".audio_enc_mpt_self.text.const")
#pragma code_seg(".audio_enc_mpt_self.text")
#endif
...
#include "audio_dut/HpEst_Loop.h"
