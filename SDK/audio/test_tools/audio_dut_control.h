...
/*******************CVP测试命令集*********************/
#define CVP_DUT_TALK_MIC                    0x01        //测试TALK MIC
#define CVP_DUT_TALK_FF_MIC                 0x02        //测试TALK FF MIC
#define CVP_DUT_ALGORITHM_OUTPUT            0x03        //测试CVP算法输出

#define CVP_DUT_NS_OPEN                     0x04        //打开NS模块
#define CVP_DUT_NS_CLOSE                    0x05        //关闭NS模块

//ANC MIC 频响测试指令，且需切换到CVP_DUT_MODE_BYPASS，在通话HFP前设置
#define CVP_DUT_ANC_FF_MIC                  0x06        //测试TWS FF MIC/头戴式左耳FF_MIC
#define CVP_DUT_ANC_FB_MIC                  0x07        //测试TWS FB MIC/头戴式左耳FB_MIC
#define CVP_DUT_ANC_R_FF_MIC                0x08        //测试头戴式右耳FF_MIC
#define CVP_DUT_ANC_R_FB_MIC                0x09        //测试头戴式右耳FB_MIC
...
#define CVP_DUT_TALK_FB_MIC                 0x0e        //测试TALK FB MIC
...
#define CVP_DUT_TALK_VPU                    0x16        //测试骨声纹VPU通道数据
