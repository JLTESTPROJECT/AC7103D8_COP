...
#define CONFIG_ENTRY_ADDRESS                    0xFE00100             //程序入口地址，一般不需要修改(跟张恺讨论过把RESERVED_OPT=0合并到一个配置项)
#endif
...
SDK_VERSION = AC710N_V3.0.0; //jenkins脚本生成
#else
...
CAT2(TONE_FILE_RESERVED_AREA_CONFIG_NAME, ADR) = AUTO;
